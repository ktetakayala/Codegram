      ...
      <div className="row">
        <div className="col-md-6 d-flex flex-column">
          <img
            ...
            alt="profile pic"
            src="https://c4.wallpaperflare.com/wallpaper/304/52/839/che-guevara-wallpaper-preview.jpg"
          />
          <p
            className=""
            style={{
          ...
          <p className="bio small">Soldier || Follow </p>
          <p className="bio small"> mohan and team {user.email}</p>
        </div>
